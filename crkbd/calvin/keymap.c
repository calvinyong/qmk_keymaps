...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
        ...
        KC_LSFT,       KC_Z, KC_X, KC_C, KC_D, KC_V,                                     KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                                      KC_LGUI, LOWER,     KC_SPC, LGUI_T(KC_ENT),        RAISE, KC_LALT
    ),


    [_LOWER] = LAYOUT(
        KC_TILD, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                           KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
         KC_DEL, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, _______,                           _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, _______,  KC_DEL,  KC_END, KC_PGDN, _______,                          _______, RGB_MOD,  RGB_SAI, RGB_HUI,  RGBRST, _______,
                                            _______, _______,    _______, _______,     _______, _______
    ),
};
