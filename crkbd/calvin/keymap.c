...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V,                             KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                          KC_LGUI, MO(_LOWER),  KC_SPC, LT(_EXTRA,KC_ENT), MO(_RAISE), KC_LALT
    ),
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        _______, _______,  KC_INS, KC_HOME, KC_PGUP, _______,                       RGB_TOG, RGB_MOD,  RGB_M_G,  KC_F11,  KC_F12, _______,
        _______, _______,  KC_DEL,  KC_END, KC_PGDN, _______,                       _______, RGB_HUI,  RGB_SAI, RGB_VAI, _______, _______,
    ...
    [_EXTRA] = LAYOUT_split_3x6_3(
        ...
        _______, _______, _______, A(KC_C), _______, _______,                        _______, _______, _______, _______, _______, _______,
                                            _______, _______,  G(KC_SPC),  _______,  _______, _______
    ),
